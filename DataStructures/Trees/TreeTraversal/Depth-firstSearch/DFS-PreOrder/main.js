...
class BinarySearchTree {
    ...
    DFSPreOrder() {
        ...
        function traverse(node) {
            /* 
                recursive helper function that pushes the node value to our data array,
                checks if the passed node has a left or right property,
                and continues to traverse the tree if so. 
            */
