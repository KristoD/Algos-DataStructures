...
class BinarySearchTree {
    ...
    DFSPostOrder() {
        ...
        function traverse(node) {
            /*
                recursive helper function that checks if the passed node has a left or right property,
                continues to traverse the tree if so,
                then pushes the node value to our data array. 
            */
